...
architecture comportamiento of Validar_movimiento is
    ...
    signal s_celda_seleccionada : STD_LOGIC_VECTOR (1 downto 0); --Contiene el estado actual
   
    signal s_es_valido : STD_LOGIC; 
begin

    with coordenada select s_celda_seleccionada <=
        estado_tablero(17 downto 16)   when "0000", -- Pos 0
        estado_tablero(15 downto 14)   when "0001", -- Pos 1
        estado_tablero(13 downto 12)   when "0010", -- Pos 2
        estado_tablero(11 downto 10)   when "0011", -- Pos 3
        estado_tablero(9 downto 8)   when "0100", -- Pos 4
        estado_tablero(7 downto 6) when "0101", -- Pos 5
        estado_tablero(5 downto 4) when "0110", -- Pos 6
        estado_tablero(3 downto 2) when "0111", -- Pos 7
        estado_tablero(1 downto 0) when "1000", -- Pos 8
