...
-- E_maquina	=>  Location: PIN_F8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- e_tablero	=>  Location: PIN_H8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- E_teclado	=>  Location: PIN_E8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- modo_actual	=>  Location: PIN_D22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- puntos_j1[0]	=>  Location: PIN_C5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- puntos_j1[1]	=>  Location: PIN_D5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- puntos_j2[0]	=>  Location: PIN_H7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- puntos_j2[1]	=>  Location: PIN_C4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- victoria_final[0]	=>  Location: PIN_C3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- victoria_final[1]	=>  Location: PIN_C6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- resultado_final	=>  Location: PIN_D4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- limpiar_tablero	=>  Location: PIN_E5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- turno_jugador	=>  Location: PIN_G7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- inicio_partida	=>  Location: PIN_E4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- pulso_jugada	=>  Location: PIN_B3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- jugada_valida	=>  Location: PIN_F7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_J2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- reset_n	=>  Location: PIN_J1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- gana_j1	=>  Location: PIN_D3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- empate	=>  Location: PIN_A4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- gana_j2	=>  Location: PIN_C2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- confirmar_modo	=>  Location: PIN_B4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- fin_juego	=>  Location: PIN_A3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Selector0~4_combout\ = ((\reset_n~input_o\ & ((\fstate.reseteo~q\) # (!\fstate.INICIO~q\)))) # (!\Selector7~0_combout\)
...
-- Equation(s):
-- \Selector3~0_combout\ = (\fstate.IN_P~q\) # ((!\jugada_valida~input_o\ & (\fstate.ESP_J~q\ & !\pulso_jugada~input_o\)))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\fstate.INICIO~q\ & (\confirmar_modo~input_o\ & (\fstate.SEL_MOD~q\ & !\fstate.reseteo~q\)))
...
-- Equation(s):
-- \Selector4~1_combout\ = (\fstate.ESP_J~q\ & ((\pulso_jugada~input_o\) # (\jugada_valida~input_o\)))
...
-- Equation(s):
-- \Selector1~0_combout\ = (!\fstate.reseteo~q\ & (\reset_n~input_o\ & !\fstate.INICIO~q\))
...
-- Equation(s):
-- \Selector2~1_combout\ = (\confirmar_modo~input_o\ & \fstate.SEL_MOD~q\)
...
-- Equation(s):
-- \Selector7~0_combout\ = (!\fstate.IN_P~q\ & (!\fstate.FIN_P~q\ & !\fstate.VER_F~q\))
...
-- Equation(s):
-- \Selector0~1_combout\ = (!\fstate.reseteo~q\ & (!\fstate.SEL_MOD~q\ & \fstate.INICIO~q\))
...
-- Equation(s):
-- \Selector4~4_combout\ = (\Selector4~2_combout\) # (((\Selector4~1_combout\) # (\Selector4~3_combout\)) # (!\Selector7~0_combout\))
...
-- Equation(s):
-- \Selector4~5_combout\ = (!\process_0~3_combout\ & ((\Selector4~1_combout\) # ((\fstate.VERIF~q\ & !\Selector4~4_combout\))))
...
-- Equation(s):
-- \Selector2~4_combout\ = (!\reset_n~input_o\ & (!\fstate.ESP_J~q\ & (!\fstate.VERIF~q\ & !\fstate.SEL_MOD~q\)))
...
-- Equation(s):
-- \Selector7~1_combout\ = (\fstate.SEL_MOD~q\) # ((!\Selector4~1_combout\ & ((\fstate.ESP_J~q\) # (!\Selector4~2_combout\))))
...
-- Equation(s):
-- \Selector7~2_combout\ = (\Selector7~0_combout\ & (\fstate.RES_F~q\ & (!\Selector2~4_combout\ & \Selector7~1_combout\)))
...
-- Equation(s):
-- \Selector7~3_combout\ = (\Selector2~2_combout\ & (((!\Selector2~1_combout\ & \Selector7~2_combout\)))) # (!\Selector2~2_combout\ & ((\fstate.VER_F~q\) # ((!\Selector2~1_combout\ & \Selector7~2_combout\))))
...
\Selector5~8\ : cycloneiii_lcell_comb
-- Equation(s):
-- \Selector5~8_combout\ = (\fin_juego~input_o\ & (\fstate.VERIF~q\ & ((\reset_n~input_o\) # (!\fstate.RES_F~q\))))
...
-- Equation(s):
-- \contador_partidas[0]~1_combout\ = \fstate.FIN_P~q\ $ (contador_partidas(0))
...
-- Equation(s):
-- \contador_partidas[2]~2_combout\ = contador_partidas(2) $ (((\fstate.FIN_P~q\ & (contador_partidas(0) & contador_partidas(1)))))
...
-- Equation(s):
-- \Selector2~2_combout\ = (!contador_partidas(2) & ((!contador_partidas(0)) # (!contador_partidas(1))))
...
-- Equation(s):
-- \Selector2~3_combout\ = (\Selector7~0_combout\ & ((\Selector2~1_combout\) # ((\fstate.VER_F~q\ & \Selector2~2_combout\)))) # (!\Selector7~0_combout\ & (\fstate.VER_F~q\ & ((\Selector2~2_combout\))))
...
-- Equation(s):
-- \WideOr0~combout\ = (\fstate.IN_P~q\) # ((\fstate.reseteo~q\) # (!\fstate.INICIO~q\))
...
-- Equation(s):
-- \turno_jugador_int~0_combout\ = \turno_jugador_int~q\ $ (\jugada_valida~input_o\)
...
-- Equation(s):
-- \process_0~4_combout\ = (!contador_partidas(0) & (!contador_partidas(2) & (\fstate.IN_P~q\ & !contador_partidas(1))))
