...
entity teclado_test_2 is
	...
	port(
      ...
      --tecla_reset, tecla_j1_vs_j2, tecla_j_vs_mq : out std_logic; 
		...
		t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16: out std_logic

	);

end entity;

architecture registro of teclado_test_2 is
--Declaracion de tipos
   type matriz_tipo is array (0 to 3, 0 to 3) of std_logic;
   type vector_tipo is array (1 to 16) of integer range 0 to 50000;
--Declaracion de señales	
	...
	--señales para probar
	signal t_1,t_2,t_3,t_4,t_5,t_6,t_7,t_8,t_9,t_10,t_11,t_12,t_13,t_14,t_15,t_16: std_logic;
...
-- Asisgnacion de salidas
	process (mat,D,COUNT_1,COUNT_2,t_1,t_2,t_3,t_4,t_5,t_6,t_7,t_8,t_9,t_10,t_11,t_12,t_13,t_14,t_15,t_16)
	begin
	--case COUNT_1 is
	--when 0 => color_j1<="000";
	--when 1 => color_j1<="001";
