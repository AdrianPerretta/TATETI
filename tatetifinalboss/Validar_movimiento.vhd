...
Begin
    ...
    begin
        ...
        case coordenada is
            ...
            -- Fila 2 --
            when "0100" => if Obtener_Celda(estado_tablero, 3) = vacio then
						s_esta_vacio <= '1'; 
						end if;
            when "0101" => if Obtener_Celda(estado_tablero, 4) = vacio then
						s_esta_vacio <= '1';
						end if;
            when "0110" => if Obtener_Celda(estado_tablero, 5) = vacio then
						s_esta_vacio <= '1';
						end if;
            
            -- Fila 2 --
            when "1000" => if Obtener_Celda(estado_tablero, 6) = vacio then
						s_esta_vacio <= '1';
						end if;
            when "1001" => if Obtener_Celda(estado_tablero, 7) = vacio then
						s_esta_vacio <= '1';
						end if;
            when "1010" => if Obtener_Celda(estado_tablero, 8) = vacio then
						s_esta_vacio <= '1';
						end if;
